...
@objc(CapacitorApplyPayPlugin)
public class CapacitorApplyPayPlugin: CAPPlugin, CAPBridgedPlugin {
    public let identifier = "CapacitorApplyPayPlugin"
    public let jsName = "CapacitorApplyPay"
...
extension CapacitorApplyPayPlugin: PKAddPaymentPassViewControllerDelegate {
...
extension CapacitorApplyPayPlugin: PKPaymentAuthorizationControllerDelegate {
