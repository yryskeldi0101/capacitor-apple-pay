...
export type ApplePayNetwork = 'amex' | 'carteBancaires' | 'chinaUnionPay' | 'discover' | 'eftpos' | 'electron' | 'idCredit' | 'interac' | 'JCB' | 'mada' | 'maestro' | 'masterCard' | 'privateLabel' | 'quicPay' | 'suica' | 'visa' | 'vPay';
...
export type PaymentCompletionStatus = 'success' | 'failure' | 'canceled' | 'invalidBillingPostalAddress' | 'invalidShippingPostalAddress' | 'invalidShippingContact' | 'pinRequired' | 'pinIncorrect' | 'pinLockout';
